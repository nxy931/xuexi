...
df.columns = ['alcohol', 'malic acid', 'ash', 'alcalinity ash', 'magnesium','species']
# 查看前5条数据
df.head()
print(df.head()) 
# 查看数据描述性统计信息
...
plt.subplot(131)
scatter_plot_by_category('magnesium', 'alcohol', 'species')
plt.xlabel('alcohal')
plt.ylabel('malic_acid')
plt.title('species')
plt.show()

plt.figure(figsize=(20, 10)) #利用seaborn库绘制不同参数图
